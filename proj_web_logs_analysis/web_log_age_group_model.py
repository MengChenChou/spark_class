...
if __name__ == "__main__":
    ...
    feature_prep = logs.select("product_category_id", "device_type", "connection_type", "age_group")
    ...
    # Model training
    classifier = RandomForestClassifier(featuresCol="features", labelCol="age_group_indexed", numTrees=10, maxDepth=10)
    ...
    # Save the model
    model.save("hdfs://devenv/user/spark/web_logs_analysis/age_group_model/")

    # Read the saved model
    model_reloaded = RandomForestClassificationModel.load("hdfs://devenv/user/spark/web_logs_analysis/age_group_model/")
